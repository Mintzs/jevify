...
from ora_decision_engine import Choice, Workflow
from ora_decision_engine.engine import DecisionEngine, SYSTEM
...
def main():
    ...
    model='Qwen/Qwen2.5-1.5B-Instruct' if tag=='windows' else str(Path.home()/'.cache/ora-decision-engine/profiling-20260918/model')
