...
from jevify import Choice, Workflow
from jevify.engine import DecisionEngine, SYSTEM
...
def main():
    ...
    model='Qwen/Qwen2.5-1.5B-Instruct' if tag=='windows' else str(Path.home()/'.cache/jevify/profiling-20260918/model')
