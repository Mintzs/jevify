...
e=DecisionEngine.from_pretrained(str(Path.home()/'.cache/ora-decision-engine/profiling-20260918/model'),device='cuda',local_files_only=True,efficient_cache=False,max_input_tokens=4096)
