...
e=DecisionEngine.from_pretrained(str(Path.home()/'.cache/ora-decision-engine/profiling-20260918/model'),device='cuda',local_files_only=True,cuda_graphs=True,fused_kernels=('rmsnorm','swiglu','rope'),shared_attention='off',specialize_short=False,length_aware=False)
c=Cupti();report={}
