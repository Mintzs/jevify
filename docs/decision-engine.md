...
.cache/decision-engine/venv/Scripts/python.exe -m ora_decision_engine --input examples/decision_engine/refund.json --device cuda --output outputs/decision-engine/refund.json
```
...
```python
from ora_decision_engine import Choice, Noul
...
.cache/decision-engine/venv/Scripts/python.exe -m ora_decision_engine.benchmark --input examples/decision_engine/refund.json --device cuda --repeats 5 --include-json --output outputs/decision-engine/benchmark.json
```
...
.cache/decision-engine/venv/Scripts/python.exe -m ora_decision_engine.benchmark --input outputs/decision-engine/replica-presets/support_triage.request.json --device cuda --repeats 5 --output outputs/decision-engine/support-triage.json
```
